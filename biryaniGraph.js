...
// function cutVegatables(state){
//     console.log('cutting the vegetable')
//     return state;
// }
...
// }
// const graph =new StateGraph(MessagesAnnotation)
// .addNode('cutVegatables',cutVegatables)
// .addNode('boilTheRice',boilTheRice)
// .addNode('addTheSalt',addTheSalt) 
// .addNode('tasteTheBiryani',tasteTheBiryani) 
// .addEdge('__start__','cutVegatables')
// .addEdge('cutVegatables','boilTheRice') 
// .addEdge('addTheSalt','boilTheRice') 
// .addEdge('addSalt','tasteBiryani')
// .addEdge('tasteBiryani','__end__')
// .addConditionalEdges('tasteBiryani',whereToGo)
